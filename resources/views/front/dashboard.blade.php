<x-front-layout>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="mb-3">
                            <tr><td>No. Pendaftar</td><td>:</td><td><b> {{$pendaftar->periode->tahun.(substr('0000'.$pendaftar->no_pendaftar, -4))}} </b></td></tr>
                            <tr><td>Nama</td><td>:</td><td> {{$pendaftar->nama}} </td></tr>
                            <tr><td>NISN</td><td>:</td><td> {{$pendaftar->nisn}} </td></tr>
                            <tr><td>Tempat/Tanggal Lahir</td><td>:</td><td> {{$pendaftar->tempat_lahir}}, {{$pendaftar->tanggal_lahir}} </td></tr>
                            <tr><td>Jenis Kelamin</td><td>:</td><td> {{$pendaftar->jenis_kelamin}} </td></tr>
                            <tr><td valign="top">Alamat</td><td>:</td>
                                <td>
                                    {{$pendaftar->alamat}} <br>
                                    Desa: {{$pendaftar->desa}} RT: {{$pendaftar->rt}} RW: {{$pendaftar->rw}} <br>
                            ...
                            <tr><td>Pilihan Jurusan</td><td>:</td><td> {{$pendaftar->jurusan->nama_jurusan}} </td></tr>
                            <tr><td>Tanggal Daftar</td><td>:</td><td> {{$pendaftar->created_at->isoFormat('dddd, D MMMM Y') }} </td></tr>
                            <tr><td>Hasil Seleksi</td><td>:</td><td> {{strtoupper($pendaftar->status_seleksi) }} </td></tr>
                        </table>
    ...
    <!-- memanpilkan widget dengan posisi bawah -->
    <x-slot name="footer">
