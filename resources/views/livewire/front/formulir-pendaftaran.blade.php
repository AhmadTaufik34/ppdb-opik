<div class="card">
    @if ($id_pendaftar==null and Carbon\Carbon::now()->isBefore($periode->tanggal_buka))
        <div class="card-body">
            <h3 class="text-muted">Penerimaan siswa baru belum dibuka</h3>
        </div>
    @elseif($id_pendaftar==null and Carbon\Carbon::now()->isAfter($periode->tanggal_tutup))
        <div class="card-body">
            <h3 class="text-muted">Penerimaan siswa baru sudah ditutup</h3>
        </div>
    @else
        <form wire:submit.prevent="save">
            <div class="card-header d-flex text-white p-0">
                <x-step no="1" step="{{$step}}" label="Data Diri Pendaftar"></x-step>
                <x-step no="2" step="{{$step}}" label="Data Tempat Tinggal"></x-step>
                <x-step no="3" step="{{$step}}" label="Data Keluarga"></x-step>
                <x-step no="4" step="{{$step}}" label="Data Asal Sekolah"></x-step>
            </div>
            <div class="card-body">
                ...
                @if ($step==0)
                    ...
                    <x-form-input field="hp" label="No. Handphone" size="4"></x-form-input>
                    ...
                    <x-form-select field="id_jurusan" label="Jurusan" size="4">
                ...
                @elseif($step==1)
                    ...
                    <x-form-input field="propinsi" label="Provinsi" size="3"></x-form-input>
                ...
                @elseif($step==2)
                    ...
                    <x-form-input field="hp_wali" label="No. Handphone Wali" size="4"></x-form-input>
            ...
            <div class="card-footer d-flex justify-content-between">
                @if ($step>0)
                    <a wire:click="prevStep()" class="btn btn-primary text-white">
