...
class FormulirPendaftaran extends Component
{
    ...
    //Menentukan nilai awal properti sesuai status pendaftaran (Baru atau edit)
    ...
    public function save(){
        ...
        $this->step += 1;//naikkan tahapan pendaftaran

        //kirim pesan keberhasilan melaui event browser
        $this->dispatchBrowserEvent('show-message', ['msg'=>'Data telah disimpan']);

        //redirect ke dashboard jika ada pentyimpanan tahapan terakhir
        if($this->step > 3){
